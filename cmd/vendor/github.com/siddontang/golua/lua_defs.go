...
const (
	...
	LUA_NUMTAGS        = LuaValType(C.LUA_NUMTAGS)
	LUA_TLIGHTUSERDATA = LuaValType(C.LUA_TLIGHTUSERDATA)
)

const (
	LUA_VERSION       = "Lua " + C.LUA_VERSION_MAJOR + "." + C.LUA_VERSION_MINOR
	LUA_RELEASE       = LUA_VERSION + "." + C.LUA_VERSION_RELEASE
	...
	LUA_HOOKTAILCALL  = C.LUA_HOOKTAILCALL
